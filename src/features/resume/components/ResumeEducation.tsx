...
export function ResumeEducation() {
  return (
    <section className="py-8 print:break-inside-avoid print:py-6">
      <h2 className="text-xs font-bold uppercase tracking-[0.22em] text-neutral-500 dark:text-neutral-400">Education</h2>
        ...
        {resumeEducation.map((entry) => (
          ...
          >
            <p className="text-sm font-medium text-neutral-700 dark:text-neutral-300">
              <span className="font-semibold text-neutral-950 dark:text-neutral-50">{entry.school}</span> —{" "}
              {entry.credential}
            </p>
